<script setup>
import ComDadosVue from "./components/ComDados.vue"
...
const cachorrosDaJoana = [
  {nome: "Totó", idade: 2},
  {nome: "Laika", idade: 8},
  {nome: "Estrelinha", idade: 6}
]
</script>
...
<template>
  ...
  <RenderizacaoListas nome="Saitama" :cachorros="[]"/>
  <RenderizacaoListas nome="Joana" :cachorros="cachorrosDaJoana"/>
  ...
  <ComProps item="Lapis" :preco="2.25"/>
  <ComProps item="Regua" :preco="20.00"/>
  <DataBinding/>
